...
public class RequestValidationExceptionHandler {
  ...
  public Map<String, Map<String, String>> handleInvalidRequestException(InvalidRequestException ex) {
  ...
  @ResponseStatus
  public Map<String, Map<String, String>> handleMethodArgumentNotValidExcepion(MethodArgumentNotValidException ex) {
    Map<String, String> errors = new HashMap<>();
